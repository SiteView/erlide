...
/**
 * This example demonstrates how to connect using SSH1 RSA Hostbased authentication
 *
 * @author Lee David Painter
 */
public class SSH1HostbasedConnect {
	...
	public static void main(String[] args) {
		...
		try {
			...
			SshConnector con = SshConnector.getInstance();
               ...
               // Make sure were only connecting to SSH1 server
			 ...
			 */
			Ssh1RhostsRsaAuthentication pk = new Ssh1RhostsRsaAuthentication();

			do {
                    pk.setClientUsername(username);

				System.out.print("Private key file: ");
				SshPrivateKeyFile pkfile = SshPrivateKeyFileFactory.parse(new FileInputStream("C:/Documents and Settings/lee/.ssh/identity"));
