...
public class Hex
{
  private static HexTranslator b = new HexTranslator();
  ...
  public static byte[] encode(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    b.encode(paramArrayOfByte, paramInt1, paramInt2, arrayOfByte, 0);
    return arrayOfByte;
  }
  ...
  public static byte[] decode(byte[] paramArrayOfByte)
  {
    ...
    b.decode(paramArrayOfByte, 0, paramArrayOfByte.length, arrayOfByte, 0);
    return arrayOfByte;
  }
}
