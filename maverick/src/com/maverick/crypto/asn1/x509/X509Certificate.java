...
public class X509Certificate
{
  ...
  {
    this.d = paramX509CertificateStructure;
  }
    ...
    throws CertificateException
  {
    ...
    try
    {
      localDEROutputStream.writeObject(this.d.getTBSCertificate());
  ...
  public byte[] getSigAlgParams()
  {
    ...
    if (this.d.getSignatureAlgorithm().getParameters() != null)
    {
      ...
      {
        DEROutputStream localDEROutputStream = new DEROutputStream(localByteArrayOutputStream);
        localDEROutputStream.writeObject(this.d.getSignatureAlgorithm().getParameters());
      }
  ...
  {
    DERBitString localDERBitString = this.d.getTBSCertificate().getIssuerUniqueId();
  ...
  {
    DERBitString localDERBitString = this.d.getTBSCertificate().getSubjectUniqueId();
    if (localDERBitString != null)
    {
      byte[] arrayOfByte = localDERBitString.getBytes();
      boolean[] arrayOfBoolean = new boolean[arrayOfByte.length * 8 - localDERBitString.getPadBits()];
  ...
  public X509Extension[] getCriticalExtensionOIDs()
  {
    if (getVersion() == 3)
    {
      ...
      X509Extensions localX509Extensions = this.d.getTBSCertificate().getExtensions();
    ...
    throws CertificateException
  {
    try
    {
      AlgorithmIdentifier localAlgorithmIdentifier = this.d.getSubjectPublicKeyInfo().getAlgorithmId();
      ...
      {
        RSAPublicKeyStructure localRSAPublicKeyStructure = RSAPublicKeyStructure.getInstance(this.d.getSubjectPublicKeyInfo().getPublicKey());
    ...
    throws CertificateException
  {
    ...
    try
    {
      localDEROutputStream.writeObject(this.d);
      return localByteArrayOutputStream.toByteArray();
    }
    catch (IOException localIOException)
    {
  ...
  {
    this.c.put(paramDERObjectIdentifier, paramDEREncodable);
    this.b.addElement(paramDERObjectIdentifier);
  }

  public DEREncodable getBagAttribute(DERObjectIdentifier paramDERObjectIdentifier)
  {
    return (DEREncodable)this.c.get(paramDERObjectIdentifier);
  }
