  ...
  implements SshDsaPrivateKey
{
    ...
    throws SshException
  {
    try
    {
      ...
      this.b = new Ssh2DsaPublicKey(paramBigInteger1, paramBigInteger2, paramBigInteger3, paramBigInteger5);
    }
