...
public class PseudoTerminalModes
{
  ...
  ByteArrayWriter c = new ByteArrayWriter();
  int d;
  byte[] b;

  public PseudoTerminalModes(SshClient paramSshClient)
  {
    this.d = paramSshClient.getVersion();
  }
  ...
  public void setTerminalMode(int paramInt1, int paramInt2)
    throws SshException
  {
    try
    {
      this.c.write(paramInt1);
      if ((this.d == 1) && (paramInt1 <= 127))
        this.c.write(paramInt2);
      else
  ...
  public void setTerminalMode(int paramInt, boolean paramBoolean)
    throws SshException
  {
    setTerminalMode(paramInt, paramBoolean ? 1 : 0);
  }
 ...
 * Qualified Name:     com.maverick.ssh.PseudoTerminalModes
