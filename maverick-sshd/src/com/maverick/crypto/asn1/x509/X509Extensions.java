  ...
  implements DEREncodable
{
  ...
  public X509Extensions(ASN1Sequence paramASN1Sequence)
  {
    ...
    while (localEnumeration.hasMoreElements())
    {
      ...
      if (localASN1Sequence.size() == 3)
        this.d.put(localASN1Sequence.getObjectAt(0), new X509Extension((DERBoolean)localASN1Sequence.getObjectAt(1), (ASN1OctetString)localASN1Sequence.getObjectAt(2)));
      else
        this.d.put(localASN1Sequence.getObjectAt(0), new X509Extension(false, (ASN1OctetString)localASN1Sequence.getObjectAt(1)));
      this.e.addElement(localASN1Sequence.getObjectAt(0));
    }
  }
  ...
  public X509Extensions(Vector paramVector, Hashtable paramHashtable)
  {
    ...
    while (localEnumeration.hasMoreElements())
      this.e.addElement(localEnumeration.nextElement());
    ...
    while (localEnumeration.hasMoreElements())
    {
      ...
      this.d.put(localDERObjectIdentifier, localX509Extension);
    }
  }
  ...
  {
    return (X509Extension)this.d.get(paramDERObjectIdentifier);
  }
  ...
  public DERObject getDERObject()
  {
    ...
    {
      DERObjectIdentifier localDERObjectIdentifier = (DERObjectIdentifier)localEnumeration.nextElement();
      X509Extension localX509Extension = (X509Extension)this.d.get(localDERObjectIdentifier);
  ...
  public int hashCode()
  {
    ...
    while (localEnumeration.hasMoreElements())
    {
      ...
      i ^= this.d.get(localObject).hashCode();
    }
    return i;
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    Enumeration localEnumeration1 = this.d.keys();
    Enumeration localEnumeration2 = localX509Extensions.d.keys();
