  ...
  implements DEREncodable
{
  ...
  public X509Name(ASN1Sequence paramASN1Sequence)
  {
    ...
    while (localEnumeration.hasMoreElements())
    {
      ...
      for (int i = 0; i < localASN1Set.size(); i++)
      {
        ...
        this.a.addElement(localASN1Sequence.getObjectAt(0));
        this.Y.addElement(((DERString)localASN1Sequence.getObjectAt(1)).getString());
        this.Z.addElement(i != 0 ? new Boolean(true) : new Boolean(false));
      }
    }
  }
  ...
  public X509Name(Vector paramVector, Hashtable paramHashtable)
  {
    if (paramVector != null)
    {
      ...
      {
        this.a.addElement(paramVector.elementAt(i));
        this.Z.addElement(new Boolean(false));
      }
    }
    else
    {
      ...
      while (localEnumeration.hasMoreElements())
      {
        this.a.addElement(localEnumeration.nextElement());
        this.Z.addElement(new Boolean(false));
      }
    }
    for (int j = 0; j != this.a.size(); j++)
    {
      DERObjectIdentifier localDERObjectIdentifier = (DERObjectIdentifier)this.a.elementAt(j);
      ...
      this.Y.addElement(paramHashtable.get(localDERObjectIdentifier));
    }
  }
  ...
  public X509Name(Vector paramVector1, Vector paramVector2)
  {
    ...
    {
      this.a.addElement(paramVector1.elementAt(i));
      this.Y.addElement(paramVector2.elementAt(i));
      this.Z.addElement(new Boolean(false));
    }
  }
  ...
  public X509Name(boolean paramBoolean, Hashtable paramHashtable, String paramString)
  {
    ...
    while (localX509NameTokenizer.hasMoreTokens())
    {
      ...
      this.a.addElement(localDERObjectIdentifier);
    ...
    if (paramBoolean)
    {
      ...
      {
        ((Vector)localObject).addElement(this.a.elementAt(j));
        localVector.addElement(this.Y.elementAt(j));
        this.Z.addElement(new Boolean(false));
      }
      this.a = ((Vector)localObject);
      this.Y = localVector;
    }
  }
  ...
  public Vector getOIDs()
  {
    ...
    for (int i = 0; i != this.a.size(); i++)
      localVector.addElement(this.a.elementAt(i));
    return localVector;
  }
  ...
  public Vector getValues()
  {
    ...
    for (int i = 0; i != this.Y.size(); i++)
      localVector.addElement(this.Y.elementAt(i));
    return localVector;
  }
  ...
  public DERObject getDERObject()
  {
    if (this._ == null)
    {
      ...
      for (int i = 0; i != this.a.size(); i++)
      {
        ...
        DERObjectIdentifier localDERObjectIdentifier = (DERObjectIdentifier)this.a.elementAt(i);
        localASN1EncodableVector2.add(localDERObjectIdentifier);
        String str = (String)this.Y.elementAt(i);
        if (str.charAt(0) == '#')
        {
          str = str.toLowerCase();
      ...
      this._ = new DERSequence(localASN1EncodableVector1);
    }
    return this._;
  }
  ...
  public boolean equals(Object paramObject, boolean paramBoolean)
  {
    ...
    int i = this.a.size();
    if (i != localX509Name.a.size())
      return false;
    for (int j = 0; j < i; j++)
    {
      String str1 = ((DERObjectIdentifier)this.a.elementAt(j)).getId();
      String str2 = (String)this.Y.elementAt(j);
      String str3 = ((DERObjectIdentifier)localX509Name.a.elementAt(j)).getId();
      String str4 = (String)localX509Name.Y.elementAt(j);
      if (!str1.equals(str3))
        continue;
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      for (int m = 0; m < i; m++)
      {
        if (arrayOfBoolean[m] == 1)
          continue;
        String str3 = ((DERObjectIdentifier)localX509Name.a.elementAt(m)).getId();
        String str4 = (String)localX509Name.Y.elementAt(m);
        if (!str1.equals(str3))
          continue;
        str2 = str2.trim().toLowerCase();
        str4 = str4.trim().toLowerCase();
  ...
  private void A(StringBuffer paramStringBuffer, Hashtable paramHashtable, DERObjectIdentifier paramDERObjectIdentifier, String paramString)
  {
  ...
  public String toString(boolean paramBoolean, Hashtable paramHashtable)
  {
    ...
    int j;
    if (paramBoolean)
      for (j = this.a.size() - 1; j >= 0; j--)
      {
        if (i != 0)
          i = 0;
        else if (((Boolean)this.Z.elementAt(j + 1)).booleanValue())
          localStringBuffer.append(" + ");
        else
          localStringBuffer.append(",");
        A(localStringBuffer, paramHashtable, (DERObjectIdentifier)this.a.elementAt(j), (String)this.Y.elementAt(j));
      }
    else
      for (j = 0; j < this.a.size(); j++)
      {
        if (i != 0)
          i = 0;
        else if (((Boolean)this.Z.elementAt(j)).booleanValue())
          localStringBuffer.append(" + ");
        else
          localStringBuffer.append(",");
        A(localStringBuffer, paramHashtable, (DERObjectIdentifier)this.a.elementAt(j), (String)this.Y.elementAt(j));
