...
class G extends Base64EncodedFileFormat
  implements SshPrivateKeyFile
{
  static String L = "---- BEGIN SSH2 ENCRYPTED PRIVATE KEY ----";
  static String N = "---- END SSH2 ENCRYPTED PRIVATE KEY ----";
  byte[] M;
  ...
  {
    return isFormatted(paramArrayOfByte, L, N);
  }
  ...
  public boolean isPassphraseProtected()
  {
    try
    {
      byte[] arrayOfByte = getKeyBlob(this.M);
  ...
  {
    byte[] arrayOfByte1 = getKeyBlob(this.M);
    int i = 0;
 ...
 * Qualified Name:     com.sshtools.publickey.G
