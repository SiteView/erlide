  ...
  implements SshPrivateKeyFile
{
  ...
  C(SshKeyPair paramSshKeyPair, String paramString1, String paramString2)
    throws IOException
  {
    this.D = A(paramSshKeyPair, paramString1, paramString2);
  }
  ...
  public boolean isPassphraseProtected()
  {
    try
    {
      ByteArrayReader localByteArrayReader = new ByteArrayReader(this.D);
  ...
  public SshKeyPair A(byte[] paramArrayOfByte, String paramString)
    throws IOException, InvalidPassphraseException
  {
    try
    {
      ...
      if (i == 3)
      {
        ...
        localSshCipher.init(1, arrayOfByte4, A(paramString));
  ...
  public byte[] A(SshKeyPair paramSshKeyPair, String paramString1, String paramString2)
    throws IOException
  {
    try
    {
      if ((paramSshKeyPair.getPrivateKey() instanceof SshRsaPrivateCrtKey))
      {
        ...
        localSshCipher.init(0, arrayOfByte3, A(paramString1));
  ...
  public void changePassphrase(String paramString1, String paramString2)
    throws IOException, InvalidPassphraseException
  {
    this.D = A(A(this.D, paramString1), paramString2, this.E);
  }
