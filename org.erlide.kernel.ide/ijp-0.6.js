...
var icalParser={
	...
	parseIcal: function(icsString){
		exports.sys.print("=====================icalParser   this.getValue('VERSION',icsString) =====" + this.getValue('VERSION', icsString) +"===========\n");
		...
		//exports.sys.print("=====================icalParser=======================" + icsString +"===========\n");
		
		var reg=/BEGIN:VEVENT(\r?\n[^B].*)+/g;
		var matches=icsString.match(reg);
		//exports.sys.print("=====================icalParser  VEVENT matches ===================" + matches +"===========\n");
		if(matches){
	...
	getValue: function(propName,txt,multiple){
		if(multiple){
			...
			exports.sys.print("=====================icalParser  getValue propName ===================" + propName +"===========\n");
			...
			if(matches){ //on a trouvé la propriété cherchée
				...
				if(RegExp.$2.length>0){ //il y a des paramètres associés
					...
					for(k=0;k<params.length;k++){
						...
						exports.sys.print("=====================icalParser  pair[0]===================" + pair[0]　+ "===========\n");
						exports.sys.print("=====================icalParser  pair[1]===================" + pair[1]　+  "===========\n");
						tab_params[pair[0]] = pair[1];
					}
				}
				//console.log(tab_params);
				exports.sys.print("=====================icalParser  getValue   valeur ===================" + valeur + "===========\n");
				return {
					value:valeur,
					params:tab_params
				};
