...
oracle_jdbc_monitor(Self, Name)->
	?SETVALUE(browse,[]),
	?SETVALUE(connection_url,[]),
	?SETVALUE(user,[]),
	?SETVALUE(password,[]),
	?SETVALUE(driver,"oracle.jdbc.driver.OracleDriver"),
...
oracle_jdbc_monitor_(Self)->eresye:stop(?VALUE(name)).
