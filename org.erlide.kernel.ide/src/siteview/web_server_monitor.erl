...
web_server_monitor_(Self)->eresye:stop(?VALUE(name)).
...
%% 	simulated random data
	?SETVALUE(lastHitsPerMinute,[]),
	?SETVALUE(lastBytesPerMinute,[]),
	?SETVALUE(status,[]),
