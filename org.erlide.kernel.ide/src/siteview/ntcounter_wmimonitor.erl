...
ntcounter_wmimonitor(Self, Name)->
	?SETVALUE(machine,[]),
	?SETVALUE(pmcfile,"System.htm"),
	?SETVALUE(object,[]),
	?SETVALUE(counter,[]),
	?SETVALUE(countertype,[]),
	?SETVALUE(instance,[]),
	?SETVALUE(units,[]),
	?SETVALUE(scale,"1"),
...
ntcounter_wmimonitor_(Self)->eresye:stop(?VALUE(name)).
